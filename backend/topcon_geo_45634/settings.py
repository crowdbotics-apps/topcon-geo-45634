"""
Django settings for topcon_geo_45634 project.
...
ROOT_URLCONF = 'topcon_geo_45634.urls'
...
WSGI_APPLICATION = 'topcon_geo_45634.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "topcon_geo_45634 API",
    "DESCRIPTION": "API documentation for topcon_geo_45634 App",
    "VERSION": "v1",
}
